...
axolotl_image = (
    modal.Image.from_registry("axolotlai/main-latest")
    .pip_install(
        "huggingface_hub",
        "hf-transfer",
        "wandb",
    ...
    .entrypoint([])
    .add_local_file(Path(__file__).parent / "config_smol_2b.yml", CONFIG_FILE_PATH.as_posix())
)
...
LORA_OUTPUT_DIR = CKPT_VOLUME_DIR / "vlm-lora-out_smolvlm_2b_ZL"
MERGED_OUTPUT_DIR = CKPT_VOLUME_DIR / "vlm-merged-out_smolvlm_2b_ZL"
